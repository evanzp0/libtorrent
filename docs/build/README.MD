...
```
b2 install --toolset=msvc-14.3 --prefix=d:\develop\libtorrent link=static runtime-link=static openssl-lib=d:\develop\OpenSSL-Win64\lib openssl-include=d:\develop\OpenSSL-Win64\include
```
